...
export default function Dashboard({ auth, myPendingTasks, totalPendingTasks, totalProgressTasks, myProgressTasks, totalCompletedTasks, myCompletedTasks, totalHighPriorityTasks, myHighPriorityTasks, activeTasks }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-4 gap-2">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100 text-center">
                            <h3 className='text-red-500 text-2xl font-semibold'>Urgent Tasks</h3>
                            <p className='text-lg mt-4'>
                                <span className='mr-2'>{myHighPriorityTasks}</span>
                                {/* /
                                <span className='ml-2'>{totalHighPriorityTasks}</span> */}
                            </p>
                        </div>
                    </div>
