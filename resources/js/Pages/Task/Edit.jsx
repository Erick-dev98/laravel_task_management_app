                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            ...
                            {/* <div className="mt-4">
                                <InputLabel htmlFor="task_assigned_user_ids" value="Re-assign Users" />
                                <SelectInput
                                    name="assigned_user_ids"
                                    value={data.assigned_user_ids}
                                    id="task_assigned_user_ids"
                                    className="mt-1 block w-full"
                                    onChange={(e) => setData("assigned_user_ids", Array.from(e.target.selectedOptions, option => option.value))}
                                ...
                                <InputError message={errors.assigned_user_ids} className="mt-2" />
                            </div> */}

                            <div className="mt-4">
                                <InputLabel htmlFor="task_assigned_user" value="Re-assign User" />
                                <SelectInput
